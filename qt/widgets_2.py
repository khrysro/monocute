...
from qt.qt.dialog_preferences import *
#from qt.dialog_ask import *
from qt.qt.edit_connections_dialog import *
from qt.qt.import_progress import *
from qt.qt.import_progress import *
from PyQt5.QtWidgets import *
from common.connections import * #  ccm.common.connections import *
from common.utils import *
from common.configurations import MccmConfig
import common.constants

class connect_par(QtWidgets.QDialog):
...
'''
Dialogs for monocute Connections Manager
'''
...
class UtilityDialogs(object):
    ...
    def show_question_dialog(self, title, message):
        ...
        dialog = QMessageBox() #(None, gtk.DIALOG_MODAL, gtk.MESSAGE_QUESTION, gtk.BUTTONS_OK_CANCEL, title)
        '''
    ...
    def show_error_dialog(self, title, message):
        ...
        #self.show_common_dialog(title, message, QErrorMessage)

    def show_info_dialog(self, title, message):
        """Display an error dialog to the user"""
        QMessageBox.information(self, title, message)
        #self.show_common_dialog(title, message, QStaticText)
...
class PreferencesDialog(object):
    ...
    def __init__(self):
        ...
        self.widgets = {
            ...
            'bgimage_filechooserbutton': self.builder.get_object('bgimage_filechooserbutton'),
            'bg_colorbutton': self.builder.get_object('bg_colorbutton'),
...
class MccmCheckbox(QHBoxLayout):
...
class ManageConnectionsDialog(object):
    ...
    def connections_model(self):
        ...
        store = QStringListModel(str, str, str, str, str, str, str, str, str, str, ) # gtk.gdk.Pixbuf)
