...
install_dir="/usr/lib/mccm"
mcm_shell="/usr/lib/mccm/bin/mccm"
...
cp /usr/lib/mccm/qt/mccm_icon.xpm /usr/share/pixmaps/mccm.xpm
cp /usr/lib/mccm/qt/mccm.desktop /usr/share/applications/
